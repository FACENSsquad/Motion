 ...
 * @author Samsung
 */
public class Jupdate_cliente extends javax.swing.JFrame {

    /**
     * Creates new form Jcadastrar_cliente
     */
    public Jupdate_cliente() {
        initComponents();
    ...
    private void initComponents() {
        ...
        TITULO.setText("ATUALIZAR  INFORMAÇÕES DE CLIENTES");
        jPanel1.add(TITULO);
        TITULO.setBounds(170, 20, 380, 22);

        jLabel1.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(0, 0, 0));
        jLabel1.setText("Razão:");
        jPanel1.add(jLabel1);
        jLabel1.setBounds(70, 140, 50, 17);
        ...
        Caixa_nome.setBounds(70, 160, 240, 25);

        jLabel5.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(0, 0, 0));
        jLabel5.setText("CPF / CNPJ:");
        jPanel1.add(jLabel5);
        jLabel5.setBounds(340, 140, 90, 17);
        ...
        Caixa_cpf.setBounds(340, 160, 240, 25);

        jLabel7.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(0, 0, 0));
        jLabel7.setText("Endereço:");
        jPanel1.add(jLabel7);
        jLabel7.setBounds(70, 200, 80, 17);
        ...
        Caixa_endereco.setBounds(70, 220, 240, 25);

        jLabel6.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(0, 0, 0));
        jLabel6.setText("CEP:");
        jPanel1.add(jLabel6);
        jLabel6.setBounds(340, 200, 40, 17);
        ...
        Caixa_cep.setBounds(340, 220, 240, 25);

        jLabel2.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(0, 0, 0));
        jLabel2.setText("Municipio:");
        jPanel1.add(jLabel2);
        jLabel2.setBounds(70, 260, 80, 17);
        ...
        Caixa_municipio.setBounds(70, 280, 240, 25);

        jLabel8.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(0, 0, 0));
        jLabel8.setText("UF:");
        jPanel1.add(jLabel8);
        jLabel8.setBounds(340, 260, 34, 17);
        ...
        Campo_uf.setBounds(340, 280, 50, 24);

        jLabel3.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(0, 0, 0));
        jLabel3.setText("Telefone");
        jPanel1.add(jLabel3);
        jLabel3.setBounds(70, 320, 50, 17);
        ...
        Caixa_telefone.setBounds(70, 340, 240, 25);

        jLabel4.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(0, 0, 0));
        jLabel4.setText("E-mail");
        jPanel1.add(jLabel4);
        jLabel4.setBounds(340, 320, 39, 17);
        ...
        Caixa_email.setBounds(340, 340, 270, 25);
        ...
        jTextField1.setBounds(130, 80, 440, 19);

        jLabel9.setForeground(new java.awt.Color(0, 0, 0));
        jLabel9.setText("CPF / CNPJ:");
        jPanel1.add(jLabel9);
        jLabel9.setBounds(60, 80, 60, 15);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Jupdate_cliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Jupdate_cliente().setVisible(true);
            }
        });
    }
