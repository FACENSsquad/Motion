...
public class Jmovimentação extends javax.swing.JFrame {
    ...
    public Jmovimentação(boolean isAdmin, String userName) {
        this.isAdmin = isAdmin;
        this.userName = userName;
        initComponents();
        tabela_movimentacao();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Jmovimentação.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
